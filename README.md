[![rialms](https://rialms.github.io/gdrive_cloner/cloner.gif)](https://github.com/rialms/gdrive_cloner/blob/watch/README3.md)

# rialmsMirror
![GitHub Repo stars](https://img.shields.io/github/stars/rialms/gdrive_cloner?color=blue&style=flat)
![GitHub forks](https://img.shields.io/github/forks/rialms/gdrive_cloner?color=green&style=flat)
![GitHub contributors](https://img.shields.io/github/contributors/rialms/gdrive_cloner?style=flat)
![GitHub watchers](https://img.shields.io/github/watchers/rialms/gdrive_cloner)
[![Channel](https://img.shields.io/badge/Join%20Channel-!-red)](https://t.me/rialms)

**rialmsMirror** is a _multipurpose_ Telegram Bot writen in Python for mirroring files on the Internet to our beloved Google Drive.
...
- Updater (**NOTE**: You must upload your **token.pickle** to Index and fill your **token.pickle** url to **TOKEN_PICKLE_URL**, because your **token.pickle** will deleted after update, for more info please check [Setting up config file](https://github.com/rialms/gdrive_cloner/tree/master#setting-up-config-file))
...
- Clone this repo:
```
git clone https://github.com/rialms/gdrive_cloner rialms_cloner/
cd rialms_cloner
```
...
- **UPSTREAM_REPO**: Link for Bot Upstream Repo, if you want default update, fill `https://github.com/rialms/gdrive_cloner`.
...
- **DATABASE_URL**: Your Database URL. See [Generate Database](https://github.com/rialms/gdrive_cloner/tree/master#generate-database) to generate database (**NOTE**: If you use database you can save your sudo id permanent using `/addsudo` command).
...
- **USE_SERVICE_ACCOUNTS**: (Leave empty if unsure) Whether to use Service Accounts or not. For this to work see [Using Service Accounts](https://github.com/rialms/gdrive_cloner#generate-service-accounts-what-is-service-account) section below.
...
<p><a href="https://github.com/rialms/gdrive_cloner/blob/gh-pages/README2.md"> <img src="https://img.shields.io/badge/Deploy%20To%20Heroku-blueviolet?style=for-the-badge&logo=heroku" width="200""/></a></p>
...
# Youtube-dl authentication using [.netrc](https://github.com/rialms/gdrive_cloner/blob/master/.netrc) file
...
- [breakdowns](https://github.com/breakdowns/slam-mirrorbot) slam mirror
- [anasty17](https://github.com/anasty17) for some features & help
- [breakdowns](https://github.com/breakdowns) for slam-tg-mirror-bot
- [zevtyardt](https://github.com/zevtyardt) for some direct links

And many more people who aren't mentioned here, but may be found in [Contributors](https://github.com/rialms/gdrive_cloner/graphs/contributors).
